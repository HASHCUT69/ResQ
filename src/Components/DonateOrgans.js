...
const DonateOrgans = ({presentUser}) => {
    ...
    return (
      <div>
        ...
        <center >
          <br/>
              <h4 align="center"><p style={{fontFamily:"verdana"}}>Organs Donor Details</p></h4>
            <form>
            <div className='row'>
              <div className='col'>
            ...
            <div className='row'>
              ...
              <div className='select-container'>
                <select name="organs" id="organs" onChange={changeHandler} value={data.organs}>
                  <option name='' organs="" >--Organs--</option>
                  <option name='Kidney' organs="Kidney" >Kidney</option>
                  <option name='Lungs' organs="Lungs">Lungs</option>
